...
if __name__ == '__main__':
    ...
    news_csv_path = "int_news_clean.csv"  
    stock_csv_list = [
        "../../data/int/AMZN_1mo.csv",
        "../../data/int/BABA_1mo.csv",
        "../../data/int/PDD_1mo.csv",
        "../../data/int/JD_1mo.csv",
        "../../data/int/MELI_1mo.csv",
        "../../data/int/SHOP_1mo.csv",
        "../../data/int/SE_1mo.csv",
        "../../data/int/EBAY_1mo.csv",
        "../../data/int/ETSY_1mo.csv",
        "../../data/int/DASH_1mo.csv",
        "../../data/int/UBER_1mo.csv",
        "../../data/int/BKNG_1mo.csv",
        "../../data/int/TCOM_1mo.csv",
        "../../data/int/W_1mo.csv",    
        "../../data/int/AFRM_1mo.csv",  
        "../../data/int/PYPL_1mo.csv",
        "../../data/int/GLBE_1mo.csv",
        "../../data/int/NTES_1mo.csv",
        "../../data/int/CHWY_1mo.csv",
        "../../data/int/FVRR_1mo.csv"
