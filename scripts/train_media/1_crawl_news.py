...
query = (
    '"streaming media" OR OTT OR SVOD OR AVOD OR "live streaming" OR '
    '"online gaming" OR esports OR "digital music streaming" OR podcast OR '
    '"virtual concert" OR "interactive media" OR "subscription video"'
...
csv_filename = "newsapi_media_news.csv"
