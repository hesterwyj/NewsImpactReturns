...
if __name__ == '__main__':
    ...
    news_csv_path = "ev_news_clean.csv"  
    stock_csv_list = [
        "../../data/ev/TSLA_1mo.csv",
        "../../data/ev/NIO_1mo.csv",
        "../../data/ev/LI_1mo.csv",
        "../../data/ev/XPEV_1mo.csv",
        "../../data/ev/LCID_1mo.csv",
        "../../data/ev/RIVN_1mo.csv",
        "../../data/ev/BYDDY_1mo.csv",
        "../../data/ev/BYDDF_1mo.csv",

        "../../data/ev/WKHS_1mo.csv",
        "../../data/ev/ALB_1mo.csv",
        "../../data/ev/LAC_1mo.csv",
        "../../data/ev/SQM_1mo.csv",
        "../../data/ev/MP_1mo.csv",
        "../../data/ev/PLUG_1mo.csv",
        "../../data/ev/BLDP_1mo.csv",
        "../../data/ev/FCEL_1mo.csv",
        "../../data/ev/QS_1mo.csv",
        "../../data/ev/APTV_1mo.csv",
        "../../data/ev/CHPT_1mo.csv"
